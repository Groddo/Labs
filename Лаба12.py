...
try:
    ...
    if len(str(summa)) > t:
        print(f'\nСумма знакочередующегося ряда с заданной точностью {t} знаков после запятой: {round(summa, t)}, {summa}') 
    else:                                                                                                               
        print(f'\nСумма знакочередующегося ряда с заданной точностью {t} знаков после запятой: {summa}')                #Вывод программы
